...
-- Баримт урсгалын өргөтгөл: төрсний гэрчилгээ + эцэг эхийн үнэмлэх + OCR тааруулалт
...
alter table public.moderator_applications add column if not exists document_read_result jsonb;
