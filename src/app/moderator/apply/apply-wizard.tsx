...
export function ApplyWizard({
  ...
  const birthCertOk = !!birthCertUrl;
  ...
  // Сонгосон нэг эцэг/эхийн үнэмлэх + которынх нь гэдэг сонголт заавал
  const parentIdOk = !!parentIdUrl && !!parentIdOwner;
  ...
  const next = () => {
    ...
    if (step === 3 && !birthCertOk) return toast.error("Төрсний гэрчилгээг (бүтэн хуудсаар) авах шаардлагатай.");
    if (step === 4 && (!parentsOk || !parentIdOk)) return toast.error("Эцэг, эхийн мэдээлэл болон нэг эцэг/эхийн үнэмлэхийг бөглөнө үү.");
    ...
    if (step === 7 && !selfieOk) return toast.error("Селфи (нүүр) авах шаардлагатай.");
    if (step === 8) {
      submit();
      return;
    }
        ...
        <Card>
          <CardContent className="space-y-5">
            ...
            <div className="space-y-3 rounded-lg border border-zinc-200 p-4 dark:border-white/10">
              ...
              <p className="text-xs text-zinc-400">Сонгосон эцэг/эхийнхээ үнэмлэхний урд талыг аваарай.</p>
      ...
      {step === 6 ? (
        <Card>
          <CardContent className="space-y-4">
            ...
            <WizardNav onBack={() => setStep(5)} onNext={next} nextLabel="Селфи рүү" nextDisabled={!addressOk} />
          </CardContent>
        </Card>
      ) : null}
      ...
      {step === 7 ? (
        <Card>
          <CardContent className="space-y-4">
            ...
            <WizardNav onBack={() => setStep(6)} onNext={next} nextLabel="Үргэлжлүүлэх" nextDisabled={!selfieOk} />
          </CardContent>
        </Card>
      ) : null}
      ...
      {step === 8 ? (
        <Card>
          <CardContent className="space-y-4">
            ...
            <WizardNav onBack={() => setStep(7)} onNext={next} nextLabel={submitting ? "Илгээж байна…" : editableMode ? "Дахин илгээх" : "Анкетыг илгээх"} nextDisabled={submitting} />
