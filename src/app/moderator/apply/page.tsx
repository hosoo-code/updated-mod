...
function toWizardData(a: ModeratorApplicationData): ApplyWizardData {
  return {
    ...
    educationEmployment: a.educationEmployment,
    idCardFrontUrls: a.idCardFrontUrls,
    idCardBackUrls: a.idCardBackUrls,
    selfieFaceUrl: a.selfieFaceUrl,
    selfieLeftUrl: a.selfieLeftUrl,
    selfieRightUrl: a.selfieRightUrl,
    birthCertificateUrl: a.birthCertificateUrl,
    parentIdUrl: a.parentIdUrl,
    parentIdOwner: a.parentIdOwner,
    identityDocumentType: a.identityDocumentType ?? "id",
    father: a.father,
    mother: a.mother,
