      ...
      <div className="grid gap-4 lg:grid-cols-5">
              ...
              {stats.verificationActivity.map((a) => {
                ...
                return (
                  <div key={a.date} className="group flex flex-1 flex-col items-center gap-2">
                    ...
                    <div
                      className="w-full max-w-12 rounded-t-lg bg-zinc-950 transition-all duration-500 group-hover:bg-zinc-700 dark:bg-white dark:group-hover:bg-zinc-300"
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex-row items-center justify-between">
            ...
            <Link href="/admin/ips" className="text-xs font-semibold text-zinc-700 hover:underline dark:text-zinc-200">
              Бүгд →
            </Link>
          </CardHeader>
