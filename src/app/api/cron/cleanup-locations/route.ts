...
import { markExpiredLocations } from "@/lib/repo";

/**
 * POST /api/cron/cleanup-locations — 7 хоног хэтэрсэн location-уудыг цэвэрлэнэ.
 ...
 */
// Vercel Cron зөвхөн GET үүсгэдэг (vercel.json-ийн schedule) — GET болон POST
// аль алиныг нь хүлээн авахын тулд хоёуланг нь export хийнэ.
async function handle(req: NextRequest) {
  ...
  const result = await markExpiredLocations();
  return ok(result);
}
