...
export default async function ModeratorsPage() {
  ...
  try {
    ...
    // Production-д Supabase/schema алдаа гарвал хуудсыг унагаахгүй — хоосон жагсаалт буцаана.
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-8 sm:px-6 sm:py-12">
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <div className="flex w-full items-center gap-2 rounded-xl border border-zinc-200 bg-white px-3.5 py-2.5 shadow-sm sm:w-72 dark:border-zinc-800 dark:bg-zinc-900/70 focus-within:border-zinc-400 focus-within:ring-2 focus-within:ring-zinc-950/10 dark:focus-within:border-zinc-500 dark:focus-within:ring-white/10">
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {m.groups.slice(0, 2).map((g) => (
                        <span
                          key={g.id}
                          className="rounded-full border border-zinc-200 bg-zinc-50 px-2.5 py-1 text-[11px] font-medium text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400"
                        >
