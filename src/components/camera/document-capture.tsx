...
export function DocumentCapture({
      ...
      if (video && video.readyState >= 2 && video.videoWidth > 0) {
        ...
        if (now - lastAnalysis.current > 300) {
          ...
          if (a) {
            ...
            // Баримт хэт том болоод бүрэн frame дүүргэж, ирмэг нь тасарч байвал холдуулна
  ...
  const handleCapture = useCallback(() => {
    ...
    let blob: Blob;
    try {
      // AUTO-CROP: баримтын ирмэгийг илрүүлж зөвхөн тухайн хэсгийг тайрна.
      // Захын ширээ/гар/хана хаягдлаж, зөвхөн үнэмлэх/гэрчилгээг өндөр чанараар авна.
      // Найдвартай илрүүлээгүй бол бүтэн frame буцаана (fallback).
      // Иргэний үнэмлэх бол aspectRatio-оор яг үнэмлэхийн хэмжээний тэгш өнцөгтөд тааруулна.
      ...
      <div className="relative flex-1 overflow-hidden">
        {status === "denied" || status === "unavailable" || status === "error" || status === "inuse" ? (
          ...
          <>
            ...
            />
            {/* Document frame — баримт (үнэмлэх/гэрчилгээ) бүрэн хэмжээгээр багтах том хүрээ */}
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <div
                className="relative max-w-lg"
                style={
                  aspectRatio
                    ? { width: "min(88%, 56vh)", aspectRatio: String(aspectRatio) }
                    : { height: "72%", width: "92%" }
                }
              >
                <div
