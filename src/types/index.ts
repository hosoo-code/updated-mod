...
/** Баримтын төрөл — өргөдөл гаргагч аль баримтаар баталгаажуулахыг сонгоно.
 *  'id' = өөрийн иргэний үнэмлэх (урд+ард);
 *  'birth-cert' = төрсний гэрчилгээ + эцэг/эхийн аль нэгний үнэмлэх. */
export type IdentityDocumentType = "id" | "birth-cert";
...
export interface ModeratorApplicationData {
  ...
  /** Баримтын төрөл — 'id' эсвэл 'birth-cert' */
...
export interface ApplyWizardData {
  ...
  parentIdUrl: string | null;
  parentIdOwner: ParentIdOwner | null;
  /** Wizard-д сонгосон баримтын төрөл — draft хэвээр хадгалагдана */
  identityDocumentType: IdentityDocumentType;
  father: ParentInfo;
  mother: ParentInfo;
  bankAccounts: BankAccountInput[];
