...
/** Эцэг эхийн аль нэгнийх нь үнэмлэхийг авсан — которынх нь */
export type ParentIdOwner = "father" | "mother";

/** OCR баримт унших provider — pluggable (VPN `provider:"none"` загвар) */
export type DocReaderProvider = "google" | "tesseract" | "none";
/** Эцэг эхийн мэдээлэл төрсний гэрчилгээний бүртгэлтэй таарсан эсэх */
export type DocReadMatchStatus = "matched" | "mismatch" | "pending";

/** Төрсний гэрчилгээг уншиж, эцэг эхийн мэдээлэлтэй тааруулсан нотолгоо */
export interface DocumentReadResult {
  provider: DocReaderProvider;
  /** OCR-оос гаргасан бүрэн текст (null = уншиж чадаагүй/тохируулаагүй) */
  extractedText: string | null;
  matchStatus: DocReadMatchStatus;
  father: { matched: boolean; score: number }; // score 0-1
  mother: { matched: boolean; score: number };
  issues: string[];
...
export interface ModeratorApplicationData {
  ...
  /** Нүүр зүүн тийш эргэсэн байрлалын селфи (3-байрлалт гурван объект) */
  selfieLeftUrl: string | null;
  /** Нүүр баруун тийш эргэсэн байрлалын селфи (3-байрлалт гурван объект) */
  ...
  /** Төрсний гэрчилгээний бүтэн хуудасны зураг (object key) */
  birthCertificateUrl: string | null;
  /** Сонгосон нэг эцэг/эхийн үнэмлэх урд талын зураг (object key) */
  parentIdUrl: string | null;
  /** Тэр үнэмлэх которынх нь — ээж үү, аав уу */
  parentIdOwner: ParentIdOwner | null;
  /** Төрсний гэрчилгээ OCR + эцэг эхийн тааруулалтын нотолгоо */
  documentReadResult: DocumentReadResult | null;
  father: ParentInfo;
  mother: ParentInfo;
...
export interface FaceCheckResult {
  ...
  checks: {
    ...
    confidence: number;
    /** Нүүрний 3 байрлал (урд/зүүн/баруун)-аас амжилттай avsан тоо (0-3) */
    poseCaptures: number;
    /** Нүүр халхалсан эсэх (маск/гар/үс) — зөвхөн landmarker backend-д, бусад үед false */
    occluded: boolean;
  };
  note: string | null;
}
