...
const parentSchema = z.object({
  ...
  phone: z.string().trim().regex(PHONE_REGEX, "Утасны дугаар буруу байна").max(20).or(z.literal("")),
...
export const applyWizardSubmitSchema = z.object({
  ...
  birthCertificateUrl: z.string().min(5).max(500).optional().or(z.literal("")),
  parentIdUrl: z.string().min(5).max(500).optional().or(z.literal("")),
